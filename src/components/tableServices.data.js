...
export const cols = [
  {id: 'idNumberServices', label: 'No.'},
  {id: 'idServices', label: 'ID Servicio'},
  {id: 'nameServices', label: 'Nombre'},
  {id: 'durationServices', label: 'Duración'},
  {id: 'priceServices', label: 'Precio'},
  {id: 'descriptionServices', label: 'Descripción'},
  {id: 'idIcons'},
]
